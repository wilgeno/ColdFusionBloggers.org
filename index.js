...
if(process.env.VCAP_SERVICES) {
    ...
    var mongo = {
		...
		"password":"",
		"name":"",
		"db":"cfb" //updated to match what was imported
    }
};
...
app.use(function(req, res, next) {
	var slogans = ["because ColdFusion bloggers can't shut up","because ColdFusion bloggers love to blog","because ColdFusion bloggers aren't paranoid... really","this slogan for rent","building sites better and faster","ColdFusion - the best dead language","ColdFusion 2018!"];
...
app.get('/rss.cfm', function(req, res) {
...
app.get('/click.cfm', function(req, res) {
	return res.redirect('/');
});
